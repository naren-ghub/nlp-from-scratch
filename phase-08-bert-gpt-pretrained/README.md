...
| 10 | [Capstone: End-to-End Application](10_capstone_end_to_end_application.ipynb) | Pipeline architecture, NewsAnalyzer class (BART/BERT/GPT-2 modules), performance profiling, dashboard |
